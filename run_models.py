...
# arima_header, arima_test, arima_result = arima_sampling(data, seq_len=seq_len, pre_len=pre_len, repeat=repeat, is_continuous=is_continuous, sampling_rate=sampling_rate, p=1, d=0, q=0)
